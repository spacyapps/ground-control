...
- Square, **192×192px**. They display at 48pt, so this
...
- The four must read as the **same character in four moods**, and be
  distinguishable at a glance at 48pt. Silhouette and colour do
...
```json
{
  ...
  "colors": {
    ...
    "rowBackground":      "#14141c",
    "rowBackgroundAlt":   "#181820",
