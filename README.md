...
| **OpenAI Codex** | yes | **no** | real cwd/name/working-done, read from its own local files — its one real "needs you" moment (an escalated-permission prompt) writes to no file at all while it waits, confirmed live · 2026-09-11 |
